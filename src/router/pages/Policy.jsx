          ...
          <div id="container">
            <div id="subCon">
              <div className="sub_cont">
                <h2 className="sub_title">개인정보취급방침</h2>

                <div className="contents">
                  <div className="agree">
                    <p>
                      {" "}
                      &lt;웰더스 시니어재활센터&gt; ('https://welders.co.kr'이하
                      '웰더스 시니어재활센터 홈페이지')은(는) 개인정보보호법에
                    ...
                    <p>
                      {" "}
                      &lt;웰더스 시니어재활센터&gt; ('웰더스 시니어재활센터
                      홈페이지') 은(는) 회사는 개인정보처리방침을 개정하는 경우
                      웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
                    </p>
                    <p>○ 본 방침은부터 2017년 3월 1일부터 시행됩니다.</p>
                    <h4>1. 개인정보의 처리 목적 </h4>
                    <p>
                      &lt;웰더스 시니어재활센터&gt; ('https://welders.co.kr'이하
                      '웰더스 시니어재활센터 홈페이지')은(는) 개인정보를 다음의
                    ...
                    <p>
                      ...
                      따른 본인확인, 서비스 부정이용 방지 등을 목적으로
                      개인정보를 처리합니다.
                    </p>
                    <h4>2. 개인정보 파일 현황</h4>
                    <p>
                      &lt;웰더스 시니어재활센터&gt; ('https://welders.co.kr'이하
                      '웰더스 시니어재활센터 홈페이지')가 개인정보 보호법
                      제32조에 따라 등록․공개하는 개인정보파일의 처리목적은
                      다음과 같습니다.
                    </p>
                    <ul>
                      <li>
                        1. 개인정보 파일명 : 웰더스 시니어재활센터 회원
                        <br />
                        - 개인정보 항목 : 이메일, 휴대전화번호, 비밀번호,
                        로그인ID, 성별, 생년월일, 이름
                        <br />
                        - 수집방법 : 홈페이지, 서면양식
                        <br />
                    ...
                    <p>
                      ※ 기타('https://welders.co.kr'이하 '웰더스 시니어재활센터
                      홈페이지')의 개인정보파일 등록사항 공개는 행정안전부
                      개인정보보호 종합지원 포털(www.privacy.go.kr) →
                      개인정보민원 → 개인정보열람등 요구 → 개인정보파일 목록검색
                      메뉴를 활용해주시기 바랍니다.
                    </p>
                    <h4>3. 개인정보처리 위탁</h4>
                    <ul>
                      <li>
                        ① &lt;웰더스 시니어재활센터&gt; ('웰더스 시니어재활센터
                        홈페이지')은(는) 원활한 개인정보 업무처리를 위하여
                        다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
                      </li>
                      <li>
                        ② &lt;웰더스 시니어재활센터&gt;
                        ('https://welders.co.kr'이하 '웰더스 시니어재활센터
                        홈페이지')은(는) 위탁계약 체결시 개인정보 보호법
                    ...
                    <h4>
                      4. 정보주체의 권리,의무 및 그 행사방법 이용자는
                      개인정보주체로서 다음과 같은 권리를 행사할 수 있습니다.
                    </h4>
                    <ul>
                      <li>
                        ① 정보주체는 웰더스
                        시니어재활센터(‘https://welders.co.kr’이하 ‘웰더스
                        시니어재활센터 홈페이지) 에 대해 언제든지 다음 각 호의
                      ...
                      <li>
                        ② 제1항에 따른 권리 행사는웰더스
                        시니어재활센터(‘https://welders.co.kr’이하 ‘웰더스
                        시니어재활센터 홈페이지) 에 대해 개인정보 보호법
                        시행규칙 별지 제8호 서식에 따라 서면, 전자우편,
                        모사전송(FAX) 등을 통하여 하실 수 있으며
                        &lt;기관/회사명&gt; (‘사이트URL’이하 ‘사이트명) 은(는)
                        이에 대해 지체 없이 조치하겠습니다.
                      </li>
                      <li>
                        ③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를
                        요구한 경우에는 &lt;기관/회사명&gt; (‘사이트URL’이하
                        ‘사이트명) 은(는) 정정 또는 삭제를 완료할 때까지 당해
                    ...
                    <ul>
                      <li>
                        ① &lt;웰더스
                        시니어재활센터&gt;('https://welders.co.kr'이하 '웰더스
                        시니어재활센터 홈페이지')은(는) 다음의 개인정보 항목을
                        처리하고 있습니다.
                        <br />
                        &lt;홈페이지 회원가입 및 관리&gt;
                        <br />
                        - 필수항목 : 이름 , 로그인ID , 비밀번호, 연락처, 주소,
                        접속 로그, 쿠키 , 접속 IP 정보
                        <br />- 선택항목 : 이메일{" "}
                      </li>
                    </ul>
                    ...
                    <p>
                      {" "}
                      &lt;웰더스 시니어재활센터&gt; ('웰더스 시니어재활센터
                      홈페이지')은(는) 개인정보보호법 제29조에 따라 다음과 같이
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <br />
                        &lt;웰더스 시니어재활센터&gt;('웰더스 시니어재활센터
                        홈페이지')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보
                        유출 및 훼손을 막기 위하여 보안프로그램을 설치하고
                        주기적인 갱신·점검을 하며 외부로부터 접근이 통제된
                        구역에 시스템을 설치하고 기술적/물리적으로 감시 및
                        차단하고 있습니다.
                      </li>
                      <li>
                        5. 개인정보의 암호화
                    ...
                    <ul>
                      <li>
                        ① 웰더스 시니어재활센터(‘https://welders.co.kr’이하
                        ‘웰더스 시니어재활센터 홈페이지) 은(는) 개인정보 처리에
                        관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한
                        ...
                        전화번호 : 1566-6597
                        <br />
                        이메일 : zbattle@welders.co.kr
                      </li>
                      <li>
                        ② 정보주체께서는 웰더스
                        시니어재활센터(‘https://welders.co.kr’이하 ‘웰더스
                        시니어재활센터 홈페이지) 의 서비스(또는 사업)을
                        이용하시면서 발생한 모든 개인정보 보호 관련 문의,
                        불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자
                        및 담당부서로 문의하실 수 있습니다. 웰더스
                        시니어재활센터(‘https://welders.co.kr’이하 ‘웰더스
                        시니어재활센터 홈페이지) 은(는) 정보주체의 문의에 대해
